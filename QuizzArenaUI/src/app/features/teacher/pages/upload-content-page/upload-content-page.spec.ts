...
describe('TeacherUploadContentPage', () => {
  ...
  it('should not accept non-mp3/mp4 files', () => {
    ...
    expect((fixture.componentInstance as any).file()).toBeNull();
  });
  ...
  it('should remove file on removeFile', () => {
    ...
    const event = { target: { files: [file] } } as unknown as Event;
    fixture.componentInstance.onFileSelected(event);
    expect((fixture.componentInstance as any).file()).toBeTruthy();
  ...
  it('should disable submit when form is invalid', () => {
    ...
    expect((fixture.componentInstance as any).canSubmit()).toBe(false);
  });
  ...
  it('should enable submit when file, className, and subjectId are provided', () => {
    ...
    (fixture.componentInstance as any).className.set('Test Class');
    (fixture.componentInstance as any).subjectId.set('c1');
    const file = new File(['test'], 'test.mp3');
    const event = { target: { files: [file] } } as unknown as Event;
    fixture.componentInstance.onFileSelected(event);

    expect((fixture.componentInstance as any).canSubmit()).toBe(true);
  });
  ...
  it('should toggle drag state on drag events', () => {
    ...
    expect((fixture.componentInstance as any).isDragging()).toBe(false);

    fixture.componentInstance.onDragOver({ preventDefault: vi.fn() } as unknown as DragEvent);
    expect((fixture.componentInstance as any).isDragging()).toBe(true);
  ...
  it('should set file on drop event', () => {
    ...
    expect((fixture.componentInstance as any).file()).toBeTruthy();
    expect((fixture.componentInstance as any).file()?.name).toBe('test.mp3');
  });
  ...
  it('should set isDragging to false on drop', () => {
    ...
    (fixture.componentInstance as any).isDragging.set(true);
    const file = new File(['test'], 'test.mp3');
    const dropEvent = { preventDefault: vi.fn(), dataTransfer: { files: [file] } } as unknown as DragEvent;
