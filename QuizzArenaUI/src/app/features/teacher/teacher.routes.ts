...
export const teacherRoutes: Routes = [
  ...
  { path: 'exams/publish/:quizId', data: { mode: 'publish' }, component: TeacherPublishExamPage, pathMatch: 'full' },
  { path: 'exams/edit/:quizId/:matchId', data: { mode: 'edit' }, component: TeacherPublishExamPage, pathMatch: 'full' },
